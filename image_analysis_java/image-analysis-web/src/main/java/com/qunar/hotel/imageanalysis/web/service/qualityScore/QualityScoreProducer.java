...
@Slf4j
@Service
public class QualityScoreProducer {
    private static Logger LOGGER = LoggerFactory.getLogger(com.xxxxxx.hotel.imageanalysis.web.service.qualityScore.QualityScoreProducer.class);
    ...
    public void sendImageAnalysisPlatformMsg(JSONObject param) {
        ...
        LOGGER.info("sendImageAnalysisPlatformMsg imageQuality QMQ appcode:{}, traceId:{}, imgType:{}, serviceJson:{}", appcode, traceId, imgType, serviceJsonStr);
