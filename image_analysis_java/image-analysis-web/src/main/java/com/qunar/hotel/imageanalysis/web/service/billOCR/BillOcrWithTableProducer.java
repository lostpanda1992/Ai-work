...
//public class BillOcrWithTableProducer {
//}
...
public class BillOcrWithTableProducer {
    ...
    private static Logger LOGGER = LoggerFactory.getLogger(com.xxxxxx.hotel.imageanalysis.web.service.billOCR.BillOcrWithTableProducer.class);

    @Resource
    private MessageProducer messageProducer;

    public void sendBillOcrMsg(JSONObject param) {
        Message message = messageProducer.generateMessage(TABLE_BILL_OCR_SUBJECT);
        ...
        QMonitor.recordOne(TABLE_BILL_OCR_SEND_QMQ);
        LOGGER.info("[table_bill_ocr][traceId={}]send BillOcrmMsg QMQ. appcode:{},, serviceJson:{}", traceId, appcode, serviceJsonStr);
