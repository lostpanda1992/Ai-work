...
PYTHON="/home/q/miniconda3/envs/captcha/bin/python"
#PYTHON="/home/wcf/bin/anaconda3/envs/tf37/bin/python"
PROJECTLOC=$(cd $( dirname "$0" ); pwd)
STARTSERVICE="captcha_web_service.py"

# 配置环境变量
#JAVA_HOME=/home/q/java/default
#CLASSPATH=$JAVA_HOME/lib/dt.jar:$JAVA_HOME/lib/tools.jar
#PATH=/home/q/miniconda3/bin:$JAVA_HOME/bin:$PATH
